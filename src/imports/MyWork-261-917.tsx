...
import svgPaths from "./svg-ejunma98vg";
type Wrapper6Props = {
...
function TextText1({ text }: TextText1Props) {
  return (
    <Wrapper2 additionalClassNames="h-[20px]">
...
function TextText({ text, additionalClassNames = "" }: TextTextProps) {
  return (
    <Wrapper3 additionalClassNames={clsx("h-[16.797px] relative shrink-0", additionalClassNames)}>
    ...
    <div className="bg-white relative size-full" data-name="My Work">
      <div className="absolute bg-white content-stretch flex h-[997px] items-start left-0 pl-[248px] top-0 w-[1387px]" data-name="DashboardLayout">
        <Container additionalClassNames="h-[997px]">
          <Wrapper4 additionalClassNames="bg-white w-[1139px]">
                ...
                <div className="h-[40px] relative shrink-0 w-full" data-name="Container">
                  <div className="flex flex-row items-center size-full">
                    <div className="content-stretch flex gap-[2px] items-center pl-[32px] relative size-full">
                      ...
                      <Icon />
                      <Wrapper1 additionalClassNames="h-[16.797px] w-[58.203px]">
                  ...
                  <div className="bg-white h-[141px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
                    ...
                    <div className="content-stretch flex flex-col items-start p-px relative size-full">
                      ...
                      <div className="h-[80px] relative shrink-0 w-full" data-name="Container">
                        <div className="content-stretch flex flex-col gap-[18px] items-start pt-[16px] px-[20px] relative size-full">
                          <div className="bg-white h-[44px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
                            ...
                            <div className="absolute content-stretch flex h-[42px] items-center left-px overflow-clip px-[38px] top-px w-[1031px]" data-name="Text Input">
                              <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[12px] text-[rgba(30,41,59,0.5)] tracking-[0.048px] whitespace-nowrap">hgfhhg</p>
                            </div>
                            ...
                            <div className="absolute content-stretch flex items-center justify-center left-[998px] rounded-[8px] size-[26px] top-[9px]" data-name="Button">
                              <Icon2>
                                <path d="M10.5 3.5L3.5 10.5" id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.05" />
                                <path d="M3.5 3.5L10.5 10.5" id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.05" />
                              </Icon2>
                            </div>
                          </div>
                          <div className="bg-white h-[210.797px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
                            <div className="overflow-clip rounded-[inherit] size-full">
                              <div className="content-stretch flex flex-col items-start p-px relative size-full">
                                <div className="h-[208.797px] relative shrink-0 w-full" data-name="EDDCaseManagement">
                                  <div className="absolute bg-[#f5f6f8] content-stretch flex items-center justify-center left-[495.5px] rounded-[20px] size-[40px] top-[28px]" data-name="Container">
                                    <Wrapper>
                                      <g id="Icon" opacity="0.5">
                                        <path d={svgPaths.p126da180} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                                        <path d="M15.75 15.75L12.525 12.525" id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                                      </g>
                                    </Wrapper>
                                  </div>
                                  <div className="absolute h-[16.797px] left-[470.95px] top-[78px] w-[89.109px]" data-name="Text">
                                    <p className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[16.8px] left-0 text-[#0f172a] text-[12px] top-[-0.5px] tracking-[0.048px] whitespace-nowrap">No entity found</p>
                                  </div>
                                  <div className="absolute h-[36px] left-[375.5px] top-[100.8px] w-[280px]" data-name="Text">
                                    <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[18px] left-[140.06px] text-[#64748b] text-[12px] text-center top-[-0.5px] tracking-[0.048px] w-[262px]">{`We couldn't find a match for "hgfhhg". You can enter the details manually.`}</p>
                                  </div>
                                  <div className="absolute h-[34px] left-[410.88px] rounded-[8px] top-[150.8px] w-[209.227px]" data-name="Button">
                                    <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[16.8px] left-[95.5px] text-[#1766d6] text-[12px] text-center top-[8.1px] tracking-[0.048px] whitespace-nowrap">Continue with manual entry</p>
                                    <div className="absolute left-[179.23px] size-[13px] top-[10.5px]" data-name="Icon">
                                      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 13">
                                        <g id="Icon">
                                          <path d="M2.70833 6.5H10.2917" id="Vector" stroke="var(--stroke-0, #1766D6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.975" />
                                          <path d={svgPaths.p17e9b940} id="Vector_2" stroke="var(--stroke-0, #1766D6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.975" />
                                        </g>
                                      </svg>
                                    </div>
                                  </div>
                            ...
                            <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.12)]" />
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <div className="absolute bg-[#fafafb] content-stretch flex flex-col h-[997px] items-start left-0 pr-px top-0 w-[248px]" data-name="Sidebar">
        ...
        <Wrapper4 additionalClassNames="w-[247px]">
          <div className="h-[56px] relative shrink-0 w-[247px]" data-name="Container">
            ...
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pb-px pl-[16px] relative size-full">
              <Wrapper1 additionalClassNames="h-[24px] w-[109.969px]">
          ...
          <Wrapper6 additionalClassNames="w-[247px]">
            <div className="absolute h-[144px] left-0 top-[8px] w-[247px]" data-name="Container">
              <div className="absolute content-stretch flex gap-[10px] h-[38px] items-center left-[8px] px-[12px] rounded-[8px] top-0 w-[231px]" data-name="Button">
                ...
                <Wrapper5 additionalClassNames="size-[14px]">
                  <Icon2>
            ...
            <div className="absolute content-stretch flex gap-[10px] h-[38px] items-center left-[8px] px-[12px] rounded-[8px] top-[194px] w-[231px]" data-name="NavButton">
              <Wrapper5 additionalClassNames="h-[18px] w-[20px]">
                <Icon3>
            ...
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[8px] pl-[8px] pt-[9px] relative size-full">
              <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-[231px]" data-name="Container">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[10px] items-center px-[8px] relative size-full">
                  <Wrapper5 additionalClassNames="bg-[#1766d6] rounded-[15px] size-[30px]">
                  ...
                  <Container additionalClassNames="h-[32px]">
                    <Wrapper2 additionalClassNames="w-[150px]">
                  ...
                  <div className="relative shrink-0 size-[15px]" data-name="Text">
                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
                      <Wrapper6 additionalClassNames="h-[15px]">
